                        ...
                        <div class="hosting-plan-card h-100">
                            <div class="hosting-plan-header text-center">
                                ...
                                <div class="hosting-pricing-options">
                                    @if ($product->is_recurring && $product->recurring_period == 12)
                                        {{-- Hiển thị các gói theo tháng --}}
                                        <div class="pricing-option">
                                            <span class="pricing-period">01 tháng x</span>
                                            <span class="pricing-amount">{{ number_format($product->price, 0, ',', '.') }}
                                                đ</span>
                                        </div>
                                        <div class="pricing-option">
                                            <span class="pricing-period">03 tháng x</span>
                                            <span
                                                class="pricing-amount">{{ number_format($product->price * 0.96, 0, ',', '.') }}
                                                đ</span>
                                            <span class="pricing-discount">(-4%)</span>
                                        </div>
                                        <div class="pricing-option">
                                            <span class="pricing-period">06 tháng x</span>
                                            <span
                                                class="pricing-amount">{{ number_format($product->price * 0.91, 0, ',', '.') }}
                                                đ</span>
                                            <span class="pricing-discount">(-9%)</span>
                                        </div>
                                        <div class="pricing-option selected">
                                            <i class="fas fa-check pricing-check-icon"></i>
                                            <span class="pricing-period">12 tháng x</span>
                                            <span
                                                class="pricing-amount">{{ number_format($product->sale_price ?: $product->price * 0.86, 0, ',', '.') }}
                                                đ</span>
                                            <span class="pricing-discount">(-14%)</span>
                                        </div>
                                    @else
                                        ...
                                        <div class="pricing-option selected">
                                            @if ($product->sale_price && $product->sale_price < $product->price)
                                                <span
                                                    class="pricing-old-price">{{ number_format($product->price, 0, ',', '.') }}đ</span>
                                                <span
                                                    class="pricing-amount">{{ number_format($product->sale_price, 0, ',', '.') }}
                                                    đ</span>
                                            @else
                                                <span
                                                    class="pricing-amount">{{ number_format($product->price, 0, ',', '.') }}
                                                    đ</span>
                                            @endif
                                            @if ($product->is_recurring)
                                                ...
                                                @else
                                                    <span class="pricing-period">/{{ $product->recurring_period }}
                                                        tháng</span>
                                                @endif
                                            @endif
                                        </div>
